...
internal static class ColorTransferUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-ColorTransfer";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(ColorTransferUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.ColorTransferEffectName, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
